...
TICKERS = [
    ...
    "CENCOSHOPP", "CENCOSUD", "CHILE", "CMPC", "COLBUN", "CONCHATORO",
    "COPEC", "ECL", "ENELAM", "ENELCHILE", "ENTEL", "FALABELLA", "IAM",
    "ITAUCORP", "LTM", "MALLPLAZA", "PARAUCO", "RIPLEY", "SECURITY",
    "SMU", "SONDA", "SQM-B", "VAPORES",
    # -- Las siguientes 21 no son IPSA, son del IGPA (indice mas amplio) --
    "ANTARCHILE", "QUINENCO", "BICECORP", "HABITAT", "CUPRUM",
    "PROVIDA", "PLANVITAL", "SK", "SAAM", "CAMANCHACA", "EMBONOR",
